...
![HireSense Dashboard](docs/screenshots/dashboard.png)
...
Benchmarks TF-IDF baseline similarity against advanced semantic **BERT-embeddings**.
![Matcher Preview](docs/screenshots/dashboard.png)

### 🎤 AI Interview Coach
Engaging, context-aware technical and behavioral mock interviews using RAG (Retrieval-Augmented Generation).
![Interview Coach Preview](docs/screenshots/interview_coach.png)

### 🎨 LaTeX Professional Export
One-click translation of optimized resumes into high-quality, professional LaTeX source code.
![LaTeX Preview](docs/screenshots/latex_export.png)

### 🤖 Autonomous AI Handshaking
Dynamic discovery of the best available Gemini models (2.0/2.5) for 100% regional API compatibility.
